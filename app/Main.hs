...
example1 :: IO ()
example1 = do
  let block1 = G.Assignment "x" (E.Literal 10)
  let block2 = G.Conditional (E.Leq (E.Literal 1) (E.Variable "x"))
  let block3 = G.Assignment "x" (E.Sub (E.Variable "x") (E.Literal 1))
  let block4 = G.Assignment "y" (E.Add (E.Variable "y") (E.Variable "x"))
  let block5 = G.Assignment "z" (E.Literal 2)
  let block6 = G.Assignment "z" (E.Mul (E.Variable "y") (E.Variable "z"))
  let graph =
